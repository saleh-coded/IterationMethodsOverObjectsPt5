...
const channels = [
  ...
  function searchChannels(query, channels) {
    ...
    return channels.filter((channel)=>{
        ...
        let lowerdescription = channel.description.toLowerCase();
        let lowerquery = query.toLowerCase();

        let lowername = channel.name.toLowerCase();

        // return channel.description.includes(query);
        return lowerdescription.includes(lowerquery) || lowername.includes(lowerquery);
